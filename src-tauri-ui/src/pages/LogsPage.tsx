...
export function LogsPage({
  ...
  return (
    <>
      <div className="page-title"><div><p className="eyebrow">Monitoring</p><h1>Log Aktivitas</h1></div><button className="secondary" onClick={onRefresh}>Refresh Log</button></div>
