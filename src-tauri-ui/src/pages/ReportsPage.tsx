...
export function ReportsPage({
  ...
  return (
    <div className={tw("reports-page")}>
      ...
      <section className={tw("electron-stat-grid reports-stat-grid")}>
      ...
      <section className={tw("reports-layout")}>
        <SectionCard
          className={tw("reports-chart-card")}
          title="Performa Penjualan"
          description="Perbandingan omzet dan keuntungan berdasarkan data transaksi."
          actions={<BarChart3 className={tw("text-emerald-600")} size={22} />}
        >
          <ReportPerformanceChart data={chartRows} />
        </SectionCard>

        <SectionCard className={tw("reports-side-card")} title="Metode Pembayaran" description="Komposisi pembayaran yang tercatat.">
      ...
      <SectionCard className={tw("reports-note-card")} title="Catatan Laporan">
