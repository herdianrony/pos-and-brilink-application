  ...
  return (
    <div className="grid gap-4" role="tabpanel" aria-label="Laporan">
      ...
      <section className="grid grid-cols-[minmax(0,1.25fr)_minmax(320px,.75fr)] items-start gap-4 max-[1080px]:grid-cols-1">
        ...
        <SectionCard className="rounded-[28px]" title="Metode Pembayaran" description="Komposisi pembayaran yang tercatat.">
      ...
      <SectionCard className="rounded-[28px]" title="Catatan Laporan">
