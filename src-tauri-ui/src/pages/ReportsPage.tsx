...
export function ReportsPage({
  ...
  return (
    <>
      <div className="page-title"><div><p className="eyebrow">Analitik</p><h1>Laporan</h1></div><button className="secondary" onClick={() => onExportCsv({ posRevenue, posProfit, agentProfit })}>Unduh CSV</button></div>
      <section className="stat-grid">
        ...
        <div className="stat-card amber"><span>Keuntungan Agen</span><strong>{formatRupiah(agentProfit)}</strong><small>{agentTransactions.length} transaksi agen</small></div>
      ...
      <section className="card">
        <h2>Catatan Unduhan</h2>
        <p>Unduh CSV/PDF native Tauri akan dibuat pada tahap berikutnya. Data laporan inti sudah tersedia di database lokal.</p>
      </section>
    </>
  );
}
