  ...
  return (
    <div className={tw("settings-page")}>
      ...
      <section className={tw("settings-grid")}>
        ...
        <SectionCard className={tw("settings-card")} title="Unduh Data" description="Unduh CSV ringan untuk arsip manual atau olah data di spreadsheet.">
        ...
        <SectionCard className={tw("settings-card span-all")} title="Info Aplikasi" description="Informasi penyimpanan lokal dan status keamanan data.">
