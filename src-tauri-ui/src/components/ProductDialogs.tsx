        ...
        <Modal size="sm" eyebrow="Kategori" title="Tambah Kategori" onClose={onCloseCategory}>
          <form onSubmit={onSubmitCategory} className="grid gap-3.5">
            <Field label="Nama Kategori">
              <input className="w-full rounded-2xl border border-slate-200 bg-white px-3.5 py-3 text-[15px] text-slate-900 transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/15" autoFocus placeholder="Contoh: Rokok, Snack, Aksesoris" value={categoryForm.name} onChange={(e) => onCategoryFormChange({ ...categoryForm, name: e.target.value })} />
            </Field>
          ...
          <form onSubmit={onSubmitProduct} className="grid gap-3.5 md:grid-cols-2">
            ...
            <div className="grid gap-3 md:col-span-2">
              <Field label="Gambar Produk" note="Opsional. Gambar otomatis dibuat thumbnail ringan.">
                <input className="w-full rounded-2xl border border-slate-200 bg-white px-3.5 py-3 text-[15px] text-slate-900 transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/15" type="file" accept="image/png,image/jpeg,image/webp" onChange={handleImageChange} />
              </Field>
