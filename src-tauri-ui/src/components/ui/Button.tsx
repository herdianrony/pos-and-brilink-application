...
const variants: Record<ButtonVariant, string> = {
  primary:
    "border-0 bg-gradient-to-br from-emerald-700 to-teal-500 text-white shadow-[0_10px_24px_rgba(4,120,87,.18)] hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(4,120,87,.26)]",
  secondary:
  ...
  danger:
    "border-0 bg-gradient-to-br from-rose-700 to-red-500 text-white shadow-[0_10px_24px_rgba(190,18,60,.20)] hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(190,18,60,.26)]",
  ghost:
