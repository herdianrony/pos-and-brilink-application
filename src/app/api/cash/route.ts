...
export async function GET() {
  try {
    ...
    return handleApiError("src/app/api/cash/route.ts:GET", error, "Gagal memproses data kas");
  }
}
...
export async function POST(req: Request) {
  try {
    ...
    return handleApiError("src/app/api/cash/route.ts:POST", error, "Gagal memproses data kas");
  }
}
