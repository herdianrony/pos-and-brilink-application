...
function LoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      // Full navigation is more reliable after setting httpOnly auth cookie,
      // especially in Playwright/Electron where client-side navigation can race
      // with middleware cookie visibility.
    ...
    return (
      ...
      >
        <div className="text-center">
          <div
            className="w-20 h-20 rounded-3xl gradient-primary flex items-center justify-center shadow-glow-primary mb-6 animate-float"
      ...
      >
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <h2 className="text-5xl font-extrabold leading-tight mb-4">
            Selamat
            <br />
            datang <span className="gradient-text">kembali</span>
          </h2>
          <p className="text-slate-300 text-base leading-relaxed mb-10">
            Kelola transaksi kasir, layanan agen, stok produk, dan laporan
            keuangan dalam satu sistem yang cepat &amp; menyenangkan.
          </p>
      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <div
              className="w-14 h-14 rounded-3xl gradient-primary flex items-center justify-center shadow-glow-primary"
              style={{ backgroundColor: "#00875A" }}
            >
