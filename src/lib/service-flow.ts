...
const FLOW_CONFIGS: Record<FlowType, FlowConfig> = {
  ...
  cash_withdrawal: {
    ...
    primaryActionText: "Catat Tarik Tunai {amount}",
    confirmationHeading: "Konfirmasi Pencatatan Tarik Tunai",
    confirmationBody:
      "Pastikan transfer dari nasabah sudah diterima di rekening agen dan uang tunai {amount} sudah diserahkan kepada nasabah.",
    confirmationConfirmText: "Sudah Terima Transfer & Serahkan Tunai",
  ...
  cash_deposit: {
    ...
    primaryActionText: "Catat Setor Tunai {amount}",
    confirmationHeading: "Konfirmasi Pencatatan Setor Tunai",
    confirmationBody:
      "Pastikan uang fisik sudah diterima dan dihitung, lalu transfer/setor aktual dilakukan melalui kanal resmi. Rekening tujuan: {account}. Nominal: {amount}.",
    confirmationConfirmText: "Uang Diterima & Transaksi Dicatat",
    confirmationCancelText: "Periksa Kembali",
    tone: "success",
  ...
  transfer: {
    ...
    cashBadgeTone: "info",
    cashSummaryLabel: "Tunai diterima dari nasabah",
    primaryActionText: "Catat Transfer {amount}",
    confirmationHeading: "Konfirmasi Pencatatan Transfer",
    confirmationBody:
      "Pastikan detail transfer sudah benar. Nominal: {amount}. Transfer aktual harus dilakukan manual via M-Banking/EDC/provider resmi. Catat nomor referensi setelah selesai.",
    confirmationConfirmText: "Saya Sudah Transfer via Kanal Resmi",
    confirmationCancelText: "Periksa Kembali",
    tone: "info",
    showDenomination: false,
    showFeeMethod: true,
  ...
  payment: {
    ...
    primaryActionText: "Catat Pembayaran {amount}",
    confirmationHeading: "Konfirmasi Pencatatan Pembayaran",
    confirmationBody:
      "Pastikan nominal tagihan sudah benar. Nominal: {amount}. Pembayaran aktual ke provider harus dilakukan manual. Catat nomor referensi setelah selesai.",
    confirmationConfirmText: "Saya Sudah Bayar Provider",
    confirmationCancelText: "Periksa Kembali",
    tone: "primary",
    showDenomination: false,
    showFeeMethod: true,
  ...
  topup: {
    ...
    primaryActionText: "Catat Top Up {amount}",
    confirmationHeading: "Konfirmasi Pencatatan Top Up",
    confirmationBody:
      "Pastikan nomor tujuan sudah benar. Nominal: {amount}. Top up aktual ke provider harus dilakukan manual. Catat nomor referensi setelah selesai.",
    confirmationConfirmText: "Saya Sudah Top Up via Provider",
    confirmationCancelText: "Periksa Kembali",
    tone: "primary",
    showDenomination: false,
    showFeeMethod: true,
