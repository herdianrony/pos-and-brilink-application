  ...
  return (
    <>
      {Object.entries(grouped).map(([category, services]) => (
        <div key={category}>
          <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-2 ml-1">
            {category}
          </h3>
            ...
            {services.map((service) => {
              ...
              return (
                <div key={service.id} className="relative group">
                  <button
                    data-testid={`service-card-${service.code || service.id}`}
                    ...
                    className={cn(
                      ...
                      selectedServiceId === service.id
                        ? "bg-purple-50 border-purple-400 shadow-card"
                  ...
                  >
                    ...
                    {service.useTieredFee ? (
                      ...
                      parseFloat(service.adminFee) > 0 && (
                        <Badge variant="warning">
                          Fee: {formatRupiah(service.adminFee)}
                        </Badge>
                      )
                    )}
                  </button>
