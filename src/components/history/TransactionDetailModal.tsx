...
import { Ban, Banknote, CheckCircle, Landmark, Printer, Receipt, RotateCcw, ShoppingCart, X } from "lucide-react";
import type { ReceiptData } from "@/components/ReceiptPreview";
import type { TransactionActionType, Trx, TrxDetail } from "@/types/transactions";
